...
RSpec.describe "POST /api/rest/v1/auth/logout" do
  ...
  context "with a valid refresh token" do
    ...
    it "returns 204 No Content" do
      post "/api/rest/v1/auth/logout", params: { refresh_token: raw_token }
  ...
  context "with an unknown refresh token" do
    it "returns 401" do
      post "/api/rest/v1/auth/logout", params: { refresh_token: "unknown_token" }
